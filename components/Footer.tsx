...
const Footer = async () => {
  ...
  return (
    <footer className="bg-[#1E4B8E] px-4 pb-6 font-inter border-t border-black text-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex md:flex-row flex-col flex-wrap justify-between gap-6 mt-4">
          {locale === "ko" ? (
            <ul className="">
        ...
        <div className="mt-12 flex items-center justify-center flex-col pt-6 text-sm">
